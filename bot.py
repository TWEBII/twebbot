...
def handle_user_messages(message):
    ...
    # 🛑 التحديث المطلوب: الرد الفوري عند السؤال عن المهام والخدمات
    features_keywords = [
    ...
    if any(keyword in text for keyword in features_keywords):
        help_text = (
            "🤖 **أهلاً بك! أنا مساعدك الذكي TWEB، وإليك أبرز المهام والخدمات التي يمكنني القيام بها فوراً:**\n\n"
            "📥 **1. التحميل من مواقع التواصل الاجتماعي:**\n"
            "أرسل لي أي رابط مقطع (يوتيوب، تيك توك، إنستغرام، فيسبوك...) وسأقوم بتحميله وإرساله لك كفيديو أو صوت بجودة عالية (للملفات حتى 50 ميجابايت).\n\n"
            "📸 **2. ترجمة الصور والمستندات والملفات:**\n"
            "عند إرسالك لأي صورة أو مستند، سأقوم بتوجيهك فوراً لأداة الترجمة الاحترافية المعتمدة لترجمة النصوص داخل الملفات مع الحفاظ على التنسيق الأصلي.\n\n"
            "🌙 **3. إرسال الأذكار والتنبيهات الإسلامية تلقائياً:**\n"
            "أرسل أذكار الصباح (8:00 صباحاً)، وأذكار النوم والراحة (10:05 مساءً)، وتنبيهات الأيام البيض والمناسبات الدينية ويوم الجمعة تلقائياً للمشتركين في الخاص.\n\n"
            "📚 **4. حل الأسئلة الدراسية والمناهج العلمية:**\n"
            "يمكنني مساعدتك في حل وتوضيح المسائل المعقدة، شرح الدروس، والإجابة على الأسئلة الدراسية لمختلف المراحل بدقة عالية.\n\n"
            "🧠 **5. الإجابة عن الاستفسارات والأسئلة العامة:**\n"
            "اسألني عن أي موضوع (ثقافي، تاريخي، تقني، أو عام) وسأجيبك فوراً باللغة العربية الفصحى وبشكل ذكي.\n\n"
            "🛠 **6. الدعم الفني وتخصيص التعامل:**\n"
            "يمكنك إرسال بلاغات الأعطال للمطور مباشرة، أو تحديد شروط خاصة لتغيير طريقة أسلوبي في الإجابة معك من خلال قائمة خيارات البوت.\n\n"
            "💡 _كل ما عليك فعله هو كتابة سؤالك أو إرسال رابطك مباشرة في المحادثة!_"
        )
        bot.send_chat_action(message.chat.id, 'typing')
